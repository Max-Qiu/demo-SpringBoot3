...
class CacheCustomKeyServiceTest {
    @Resource
    ...
    @Autowired
    private CacheCustomKeyService service;

    @Test
    @Order(1)
    void noParameter() {
        System.out.println(service.noParameter());
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::noParameter");
    ...
    void singleParameter() {
        ...
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::singleParameter::1");
        assertEquals("1", s);
    }
    ...
    void requestParameter() {
        ...
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::requestParameter::UserRequest(id=1, name=张三)");
    ...
    void multiParameter() {
        ...
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::multiParameter::1,2");
        assertEquals("3", s);
    }
    ...
    void requestParameter2() {
        ...
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::requestParameter2::UserRequest(id=2, name=李四),李");
    ...
    void listParameter() {
        ...
        String s = stringRedisTemplate.opsForValue().get("CacheCustomKey::listParameter::1,2,3");
